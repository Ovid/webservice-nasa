...
#<<< CodeGen::Protection::Format::Perl 0.06. Do not touch any code between this and the end comment. Checksum: cebef1af81b3e707a93cb8b57314fd3a
...
subtest 'Validate Response via OpenAPI' => sub {
    ...
    if ( $nasa->is_json ) {
        eq_or_diff $response, $expected, 'get_neo_rest_v1_neo_asteroidid response is decoded correctly' if $nasa->is_json;
    }
    else {
        ok defined $response, 'get_neo_rest_v1_neo_asteroidid response is defined';
    }
